...
public:
    PlanningUnit();
    std::string decide_best_action(const std::string& context, double energy, double boredom, double hunger = 0.0, double thirst = 0.0);
...
private:
    ...
    double simulate(PlanNode* node, double energy, double boredom, double hunger, double thirst);
